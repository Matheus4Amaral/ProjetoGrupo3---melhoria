  ...
  async function handleToggleMinhaLista() {
    if (naLista) {
      if (window.confirm("Tem certeza que deseja remover o filme da sua lista?")) {
        ...
        setNaLista(false);
        mostrarToast("Removido da sua lista", "sucesso");
      }
    } else {
      ...
      setNaLista(true);
      mostrarToast("Adicionado à Lista!", "sucesso"); 
    }
  }
  ...
  async function handleToggleAssistido() {
    if (assistido) {
      if (window.confirm("Tem certeza que deseja remover o filme dos assistidos?")) {
        ...
        setAssistido(false);
        mostrarToast("Removido dos assistidos", "sucesso");
      }
    } else {
      ...
      setAssistido(true);
      mostrarToast(" Marcado como assistido!", "sucesso");
    }
  }
