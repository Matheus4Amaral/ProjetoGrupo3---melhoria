  ...
  async function handleToggleMinhaLista() {
    if (naLista) {
      if (window.confirm("Tem certeza que deseja remover a série da sua lista?")) {
        ...
        setNaLista(false);
        mostrarToast("Removida da sua lista", "sucesso");
      }
    } else {
      ...
      setNaLista(true);
      mostrarToast("Adicionada à Lista!", "sucesso");
    }
  }
  ...
  async function handleToggleAssistido() {
    if (assistido) {
      if (window.confirm("Tem certeza que deseja remover a série dos assistidos?")) {
        ...
        setAssistido(false);
        mostrarToast("Removida dos assistidos", "sucesso");
      }
    } else {
      ...
      setAssistido(true);
      mostrarToast("Marcada como assistida!", "sucesso");
    }
  }
